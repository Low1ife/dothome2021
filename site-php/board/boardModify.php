                            ...
                            <fieldset>
                                <legend class="ir_so">게시판 수정 영역입니다.</legend>
                                    ...
                                    if( $result ){
                                        ...
                                        echo "<input type='password' name='boardPass' id='boardPass' placeholder='비밀번호를 입력해주세요!!!!' autocomplete='off' required></div>";
                                    } -->
                                ...
                                <div>
                                    ...
                                    <input type="password" name="boardPass" id="boardPass" placeholder="비밀번호를 입력해주세요!!!!" autocomplete="off" required>
                                </div> -->
                            </fieldset>
